...
export default function Menu() {
  const websiteUrl = "https://your-restaurant-link.com";
  ...
  const menuSections = [
    ...
    },
    {
      ...
      items: [
        { name: "Whole Fish Fry", price: 600, includes: ["Kachumbari", "Ugali or Chips"] },
        { name: "Whole Fish Mukimo / Chips", price: 700, includes: ["Mukimo or Chips", "Kachumbari"] },
        { name: "Chicken Fry / Ugali", price: 600, includes: ["Ugali", "Kachumbari"] },
        { name: "Chicken Fry Chips / Mukimo", price: 650, includes: ["Chips or Mukimo", "Kachumbari"] },
    ...
    },
    {
      ...
      items: [
        { name: "Choma 1Kg", price: 1200, includes: ["Kachumbari", "Chili Sauce"] },
  ...
  return (
    <div className="menu-container">
      ...
      <div className="qr-section">
        ...
        <QRCode value={websiteUrl} size={140} bgColor="#ffffff" fgColor="#000000" />
      </div>
    </div>
  );
}